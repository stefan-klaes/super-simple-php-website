...
<div class="member_cards">
    <div class="home_bereich">        			

    <h1>Imprint</h1>
         <h2>Information according to § 5 TMG</h2>
         <p>Stefan Klaes<br>Danziger Str. 2B<br>21465 Wentorf bei Hamburg</p>
         <h2>Contact</h2>
         <p>Email: stefan@coden-lassen.de</p>
         <h2>Editorial responsibility</h2>
         <p>Stefan Klaes</p>
         <h2>EU Dispute Settlement</h2>
         <p>The European Commission provides a platform for online dispute resolution (OS):&nbsp;<a href="https://ec.europa.eu/consumers/odr/" target="_blank" rel="noopener noreferrer ">https://ec.europa.eu/consumers/odr/</a>.<br>You can find our e-mail address above in the imprint.</p>
         <h2>Consumer dispute settlement/universal arbitration board</h2>
         <p>We are not willing or obliged to participate in dispute settlement procedures before a consumer arbitration board.</p>
         <h3>Liability for content</h3>
         <p>As a service provider, we are responsible for our own content on these pages according to Section 7, Paragraph 1 of the German Telemedia Act (TMG). According to §§ 8 to 10 TMG, however, we as a service provider are not obliged to monitor transmitted or stored third-party information or to investigate circumstances that indicate illegal activity.</p>
         ...
         <p>However, permanent monitoring of the content of the linked pages is not reasonable without concrete evidence of a violation of the law. As soon as we become aware of legal violations, we will remove such links immediately.</p>
         <h3>Copyright</h3>
